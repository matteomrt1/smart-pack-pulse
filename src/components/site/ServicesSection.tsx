...
export function ServicesSection() {
  return (
    <section className="bg-white text-[#111] py-[60px] pb-[70px]" id="servizi">
      <div className="max-w-[1400px] mx-auto px-5 md:px-10">
        <h2 className="text-center text-[clamp(26px,3vw,34px)] font-bold tracking-[0.06em] uppercase mb-8 text-[#ef1717]">
          I Nostri Servizi
        </h2>
        ...
        <div className="flex flex-col md:flex-row gap-6 group/row">
          {services.map((service, i) => (
            <div
              key={i}
              className="relative flex-1 h-[360px] md:h-[550px] rounded-[26px] overflow-hidden cursor-pointer bg-[#ccc] transition-all duration-[600ms] md:group-hover/row:[flex:0.8_1_0] md:hover:!flex-[2.2_1_0] md:hover:-translate-y-2 md:hover:shadow-[0_20px_45px_rgba(0,0,0,0.25)]"
            >
              {/* BG */}
              <div
        ...
        <div className="mt-12 text-center">
          <p className="text-sm text-[#777] mb-4 tracking-[0.12em] uppercase">Servizio esclusivo</p>
          <h3 className="text-2xl font-bold mb-3">Configuratore Imballaggio AI</h3>
          ...
          <Link
            to="/configurator"
            className="inline-flex items-center gap-2 bg-[#111] text-white px-8 py-3 rounded-full hover:bg-[#ef1717] transition-colors shadow-lg text-sm font-medium tracking-[0.08em] uppercase"
          >
